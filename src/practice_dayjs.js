...
export const runPracticeDayjs = () => {
  ...
  const now = dayjs('2023-11-04 16:01:30');
  ...
  const aDate = dayjs('2023-10-28 15:00:00');
  const bDate = dayjs('2023-10-30 16:00:00');
  ...
  // console.log(
  //   "21. isBetween",
  //   dayjs("2023-10-29 15:30:00").isBetween(aDate, bDate)
  // );
  // console.log(
  //   "22. isBetween date",
  //   dayjs("2023-10-29 15:30:00").isBetween(aDate, bDate, "date")
  // );
